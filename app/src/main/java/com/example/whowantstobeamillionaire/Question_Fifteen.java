...
public class Question_Fifteen extends AppCompatActivity {

    private Button submitQ15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitQ15 = findViewById(R.id.btn_Q1);
        ...
        quitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Quit = new Intent(Question_Fifteen.this, Winner.class);
        ...
        submitQ15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Get the selected answer
                RadioGroup radioGroup = findViewById(R.id.R7Q7);
                ...
                if (answer.equals("His dentist")) {// Add $100 to the player's total money
                    totalMoney += 500000;
                    ...
                    Toast.makeText(Question_Fifteen.this, message, Toast.LENGTH_SHORT).show();
                    // Delay for 2 seconds and then start the over activity
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent answerOne = new Intent(Question_Fifteen.this, GameOver.class);
