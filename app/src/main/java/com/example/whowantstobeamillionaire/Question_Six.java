...
public class Question_Six extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitQ6 = findViewById(R.id.btn_Q1);
        ...
        quitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Quit = new Intent(Question_Six.this, Winner.class);
        ...
        submitQ6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Get the selected answer
                RadioGroup radioGroup = findViewById(R.id.R7Q7);
                ...
                if (answer.equals("Scotland")) {// Add $100 to the player's total money
                    totalMoney += 2500;
                    ...
                    Toast.makeText(Question_Six.this, message, Toast.LENGTH_SHORT).show();

                    // Delay for 2 seconds and then start the second activity
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent answerOne = new Intent(Question_Six.this, Question_Seven.class);
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent answerOne = new Intent(Question_Six.this, GameOver.class);
                            answerOne.putExtra("prize", totalMoney);
                            startActivity(answerOne);
                        }
                    }, 2000); // 2000 milliseconds = 2 seconds
