...
public class Question_Thirteen extends AppCompatActivity {

    private Button submitQ13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitQ13 = findViewById(R.id.btn_Q1);
        ...
        quitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Quit = new Intent(Question_Thirteen.this, Winner.class);
        ...
        submitQ13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Get the selected answer
                RadioGroup radioGroup = findViewById(R.id.R7Q7);
                ...
                if (answer.equals("Peru")) {// Add $100 to the player's total money
                    totalMoney += 100000;
                    ...
                    Toast.makeText(Question_Thirteen.this, message, Toast.LENGTH_SHORT).show();

                    // Delay for 2 seconds and then start the second activity
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent answerOne = new Intent(Question_Thirteen.this, Question_Fourteen.class);
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent answerOne = new Intent(Question_Thirteen.this, GameOver.class);
                            answerOne.putExtra("prize", totalMoney);
                            startActivity(answerOne);
                        }
                    }, 2000); // 2000 milliseconds = 2 seconds
