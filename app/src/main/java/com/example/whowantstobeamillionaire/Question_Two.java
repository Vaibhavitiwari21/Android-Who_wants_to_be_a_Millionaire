    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Quit = new Intent(Question_Two.this, Winner.class);
        ...
        submitQ2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (answer.equals("Helium")) {// Add $100 to the player's total money
                    totalMoney += 500;
                    ...
                    Toast.makeText(Question_Two.this, message, Toast.LENGTH_SHORT).show();

                    // Delay for 2 seconds and then start the second activity
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent answerOne = new Intent(Question_Two.this, Question_Three.class);
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent answerOne = new Intent(Question_Two.this, GameOver.class);
                            answerOne.putExtra("prize", totalMoney);
                            startActivity(answerOne);
                        }
                    }, 2000); // 2000 milliseconds = 2 seconds
